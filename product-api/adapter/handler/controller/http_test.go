...
var (
	...
	deleteEntityInput = &entity.Product{
		ID: uuid.MustParse("8c2b51bf-7b4c-4a4b-a024-f283576cf190"),
	}

	productsList = &entity.ProductResponseList{
	...
	listModelOutput = &model.ProductResponseList{
...
func (h *handlerContext) aRequestIsMadeToGetTheListofProducts() error {
	...
	usecaseMock := &mocks.ProductUseCase{}
	usecaseMock.On("GetProducts", ctxGin).Return(productsList, h.err).Once()
...
func (h *handlerContext) theResponseBodyShouldMatchTheExpectedProductList() error {
	wantGot, err := json.Marshal(listModelOutput)
	if err != nil {
		return err
	}
...
func InitializeScenario(s *godog.ScenarioContext) {
	...
	s.Step(`^the response body should contain a list of products with details`, h.theResponseBodyShouldMatchTheExpectedProductList)
